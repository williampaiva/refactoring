...
<asm version="1.0" name="0">
	<cp>
		<constant value="RefactoringInnerClass"/>
		...
		<constant value="A.__matchRenameMethods():V"/>
		<constant value="__exec__"/>
		<constant value="RenameMethods"/>
		<constant value="NTransientLinkSet;.getLinksByRule(S):QNTransientLink;"/>
		<constant value="A.__applyRenameMethods(NTransientLink;):V"/>
		...
		<constant value="__matchRenameMethods"/>
		...
		<constant value="__applyRenameMethods"/>
		<constant value="NTransientLink;"/>
		<constant value="NTransientLink;.getSourceElement(S):J"/>
		<constant value="NTransientLink;.getTargetElement(S):J"/>
		<constant value="will_"/>
		<constant value="J.+(J):J"/>
		<constant value="MRefiningTrace!Element;.setProperty(SJB):V"/>
		<constant value="12:12-12:19"/>
		<constant value="12:22-12:24"/>
		<constant value="12:22-12:29"/>
		<constant value="12:12-12:29"/>
	...
	<operation name="122">
		...
		<linenumbertable>
			...
			<lne id="130" begin="13" end="13"/>
			<lne id="131" begin="13" end="14"/>
